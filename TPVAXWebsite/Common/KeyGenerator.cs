...
{
    /// <summary>
    /// Thread-safe Key Generator sử dụng timestamp + counter để tránh race condition
    /// </summary>
    public static class KeyGenerator
    {
        ...
        /// </summary>
        public static string GenMaKH(string CCCD = null)
        {
        ...
        /// </summary>
        public static string GenMaLK(string CCCD = null)
        {
        ...
        /// </summary>
        public static string GenMaHSTC(string CCCD = null)
        {
        ...
        /// </summary>
        public static string GenMaCTHD()
        {
